...
function initModal() {
  const modalData = {
    monaco: {
      ...
      info: 'Microsoft Monaco Editor is the code editor that powers VS Code',
      technologies: '<li>Web Front-end: TypeScript</li>',
      role: 'As part of the Hacktoberfest 2018 we assisted the open source project by adding templates for issues, improve their copyright tags and improve their git process'
    },
    rampit: {
      image: './img/rampit.png',
      info: 'Innovative framework that allow us to speed up the development of client websites',
      technologies: '<li>Web Front-end: VueJS</li><li>Testing: Karma and Selenium</li>',
      role: 'We were responsible for the development of the flexible component based framework'
    },
    gaaallstars: {
      image: './img/gaaallstars2.png',
      info: 'The only app you need for official PwC All-Stars news, historical All-Stars trivia and the chance to pick your Hurling and Football Teams of the Year. ',
      technologies: '<li>Mobile Front-end: NativeScript</li><li>DB: SQLite mobile</li><li>Testing: Karma and Selenium</li>',
      role: 'We were responsible for the development of the application and add create a stable solution with fully working offline mode'
    },
    cryptobeast: {
      image: './img/cryptobeast.png',
      info: 'Innovative cryptocurrency market based on ExpressJS and ReactJS, developed for <a href="https://motionsoftware.eu/">MotionSoftware</a>',
      technologies: '<li>Web Front-end: ReactJS</li><li>Back-end: ExpressJS</li><li>Testing: Karma and Selenium</li>',
      role: 'We were helping with the development of the application and add integrations to different online markets and data storages'
    },
    devolo: {
